    ...
    <AppLayout>
        <section class="relative bg-white py-8 antialiased dark:bg-gray-900 md:py-8">
            <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
                ...
                <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl md:mb-6">General
                    overview</h2>
                        ...
                        <div class="space-y-4">
                            ...
                            <dl>
                                ...
                                <dd class="flex items-center space-x-4 text-gray-500 dark:text-gray-400">
                                    ...
                                    <div>
                                        <div class="text-sm">
                                            <p class="mb-0.5 font-medium text-gray-900 dark:text-white">Visa ending in
                                                7658</p>
                                ...
                                <div class="col-span-2">
                                    ...
                                    <svg class="me-2 h-4 w-4" fill="none" viewBox="0 0 20 15">
                                        ...
                                        <filter id="filter0_d_374_135180" width="19.6" height="4.667" x="0" y="5.167"
                                            ...
                                            <feBlend in="SourceGraphic" in2="effect1_dropShadow_374_135180"
                                                     result="shape"/>
                                        </filter>
