<template>
    <AdminLayout>
        <div class="max-w-lg">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Éditer {{ user.name }}</h1>
            ...
            <form @submit.prevent="submit" class="space-y-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div>
                    <label class="block mb-1 text-sm font-medium text-gray-900 dark:text-white">Nouveau mot de passe <span class="text-gray-400 font-normal">(laisser vide pour ne pas changer)</span></label>
